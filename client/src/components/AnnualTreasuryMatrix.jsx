  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-4 sm:p-5 shadow-sm space-y-4 animate-fadeIn w-full overflow-hidden">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5">
        {/* Saldo Inicial */}
        <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/80 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold uppercase text-slate-500 dark:text-slate-400">
              Saldo Apertura (1 Ene)
            </span>
        ...
        <div className="p-3 rounded-2xl bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900/40 flex flex-col justify-between">
          <div className="flex items-center justify-between">
        ...
        <div className="p-3 rounded-2xl bg-rose-50/50 dark:bg-rose-950/20 border border-rose-200 dark:border-rose-900/40 flex flex-col justify-between">
          <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between text-[9px] text-rose-700 dark:text-rose-300 mt-1 truncate">
            <span>Reales: {Math.round(resumenAno.totalGastosRealesAno).toLocaleString()}€</span>
            <span>Prev: {Math.round(resumenAno.totalGastosPrevistosAno).toLocaleString()}€</span>
          </div>
        </div>

        {/* Ahorro Neto Previsto */}
        <div className="p-3 rounded-2xl bg-indigo-50/50 dark:bg-indigo-950/20 border border-indigo-200 dark:border-indigo-900/40 flex flex-col justify-between">
          <div className="flex items-center justify-between">
          ...
          <p className="text-[9px] text-indigo-700 dark:text-indigo-300 mt-1 truncate">
            + {Math.round(resumenAno.totalInvertidoAno).toLocaleString()}€ en Fondos/EPSV
          </p>
        </div>
